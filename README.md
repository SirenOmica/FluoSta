...
**Steps:**
1. Download `FluoStaInstaller.exe` by clicking   [![Download EXE](https://img.shields.io/badge/Download-FluoSta%20(EXE)-blue?logo=download)](https://drive.google.com/file/d/1npdZWkKfbGcJA1ZiEafF-p-hxoxot9s0/view?usp=drive_link)
...
> You may see a Windows warning like **“Windows protected your PC”** (SmartScreen) or a UAC prompt when opening the EXE. This behaviour is *normal for unsigned exe files* and does not necessarily mean the program is malicious.
> 
> **What to do:**
